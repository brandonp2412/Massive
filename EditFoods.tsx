...
export default function EditFoods() {
  const { params } = useRoute<RouteProp<FoodPageParams, 'EditFoods'>>()
  const { ids } = params
  ...
  const handleSubmit = async () => {
    console.log(`${EditFoods.name}.handleSubmit:`, { uri: newImage, name })
  ...
  return (
    <>
      <StackHeader title={`Edit ${ids.length} foods`} />
